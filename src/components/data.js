export const data = [
    {
        source: require("../assets/codeEditor.PNG"),
    ...
    {
        source: require("../assets/kittyTalk.png"),
    ...
    {
        source: require("../assets/cake-shop.png"),
        alt: "cFood Hunt Game",
    ...
    {
        source: require("../assets/foodHunt.png"),
        alt: "Food Hunt Game",
    ...
    {
        source: require("../assets/Rlogin.png"),
        alt: "code editor preview",
